...
public class HighScores : MonoBehaviour
{
    ...
    {
        // Before we try to read a file, we should check that it exists.
        // If it doesn't exist, we'll log a message abort
        ...
        // Make a new array of default values. This ensures that no old
        // values stick around if we've loaded a scores file in the past.
        ...
        // A while loop, which runs as long as there is data to be read
        // AND we haven't reached the end of our scores array.
        while (fileReader.Peek() != 0 && scoreCount < scores.Length)
        {
            ...
            else
            {
                ...
                // junk in our file. Let's print an error, and then use
                // a default value.
    ...
    public void AddScore(int newScore)
    {
        ...
        // This will be the first index with a score lower
        // than the new score
        int desiredIndex = -1;
        for (int i = 0; i < scores.Length; i++)
        {
        ...
        // If no desired index was found then the score isn't
        // high enough to get on the table, so we just abort.
        if (desiredIndex < 0)
        {
        ...
        // Then we move all of the scores after that index back
        // by one position. We'll do this by looping from the
        // back of the array to our desired index.
